    ...
    <div className={"min-h-screen p-4 transition-all font-sans " + (darkMode ? "dark bg-gray-900 text-white" : "bg-gray-100 text-black")}>
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-4">
          ...
          <img src="/logo.png" alt="Logo" className="h-24 border-4 border-white shadow-lg shadow-blue-500/50 rounded-full" />
              ...
              <div className="flex gap-2 flex-wrap">
                {powerPlayOptions.map((play) => {
                  ...
                  return (
                    ...
                    >
                      <img src={playIcon} alt={play} className="h-24 w-24 mb-1 object-contain border-4 border-white shadow-lg shadow-blue-500/50 rounded-full" />
                      <span>{play}</span>
                    </button>
                  );
                })}
