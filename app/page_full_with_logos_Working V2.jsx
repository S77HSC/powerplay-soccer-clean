    ...
    <div className={"min-h-screen p-4 transition-all font-sans " + (darkMode ? "dark bg-gray-900 text-white" : "bg-gray-100 text-black")}>
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <img src="/logo.png" alt="PowerPlay Logo" className="h-24 w-24 object-contain border-4 border-white shadow-lg shadow-blue-500/50 rounded-full" />
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-6">
          {[{ team: teamA, players: playersA, side: "A", selections: selectedPowerPlaysA, setSelections: setSelectedPowerPlaysA },
            { team: teamB, players: playersB, side: "B", selections: selectedPowerPlaysB, setSelections: setSelectedPowerPlaysB }].map(
              ({ team, players, side, selections, setSelections }) => (
                  ...
                  <div>
                    ...
                    <div className="flex gap-2 flex-wrap justify-center">
                      {powerPlayOptions.map((play) => (
                        ...
                        >
                          <img src={getPlayIcon(play)} alt={play} className="h-16 w-16 mb-1 object-contain border-4 border-white shadow-lg shadow-blue-500/50 rounded-full" />
                          <span>{play}</span>
                        </button>
                      ))}
                    </div>
